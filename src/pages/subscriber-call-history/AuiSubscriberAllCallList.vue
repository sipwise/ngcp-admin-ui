...
export default {
        ...
        columns () {
            return [
                this.getIdColumn(),
                {
                    ...
                    align: 'left',
                    format: (val, row) => {
                        return row.direction === 'in' ? row.other_cli : row.own_cli
                    }
                },
                {
                    name: 'callee',
                    ...
                    align: 'left',
                    format: (val, row) => {
                        return row.direction === 'in' ? row.own_cli : row.other_cli
                    }
                },
                {
                    name: 'clir',
    ...
    methods: {
        ...
        rowActions () {
            return [
                'subscriberAllCallFlow',
                'subscriberAllCallDetails'
            ]
        }
    }
}
