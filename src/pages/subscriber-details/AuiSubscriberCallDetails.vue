    ...
    <aui-base-sub-context>
        <aui-data-table
            ...
            :resource-default-filters="() => ({
                ...
                call_id: $route.params.unencodedCallId
            })"
            resource-type="api"
            :resource-singular="$t('Call details')"
            title=""
            :columns="columns"
            :searchable="true"
...
export default {
    ...
    methods: {
        rowActionRouteIntercept ({ route, row }) {
            ...
            route.params.encodedCallId = encodedCallId
            return route
        },
        rowActions () {
            return [
                'subscriberDetailsCallFlow',
