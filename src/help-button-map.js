...
export function configHelpButtonMap (config = {
    ...
    helpButtonMap = new Map([
        ...
        ['/calllistsuppression', config.baseUrl + '/advancedconfiguration/advancedconfiguration.html#call-list-suppressions'],
        ['/calllistsuppression/create', config.baseUrl + '/advancedconfiguration/advancedconfiguration.html#cls-single-entry'],
        ['/calllistsuppression/upload', config.baseUrl + '/advancedconfiguration/advancedconfiguration.html#cls-bulk-entry'],
