                ...
                <div class="list-container">
                    ...
                    >
                        ...
                        <q-expansion-item
                            ...
                            data-cy="aui-cfunconditional-destinationset"
                        >
                            <q-card>
                                <q-card-section>
                                    <aui-base-form-field
                                    ...
                                    >
                                        <q-input
                                            ...
                                            dense
                                            :label="$t('Name')"
                                            data-cy="aui-cfunconditional-destination-name"
                                        ...
                                        >
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    data-cy="aui-cfunconditional-destination-type"
                                                ...
                                                <q-input
                                                    ...
                                                    :disable="loading"
                                                    :label="$t('URI/Number')"
                                                    data-cy="aui-cfunconditional-destination-number"
                                                    @keyup.enter="submit"
                                                />
                                                <q-select
                                                    ...
                                                    data-cy="aui-cfunconditional-destination-custom-announcement"
                                                ...
                                                <q-input
                                                    ...
                                                    :disable="loading"
                                                    :label="$t('for(seconds)')"
                                                    data-cy="aui-cfunconditional-destination-duration"
                                                    :error="false"
                                                    @keyup.enter="submit"
                                                />
                                                <q-input
                                                    ...
                                                    :disable="loading"
                                                    :label="$t('Priority')"
                                                    data-cy="aui-cfunconditional-destination-priority"
                                                    :error="false"
                                                    @keyup.enter="submit"
                                                />
                                            </q-item-section>
                                            ...
                                            >
                                                <q-btn
                                                    ...
                                                    dense
                                                    icon="delete"
                                                    data-cy="aui-cfunconditional-destination-delete"
                                                    size="sm"
                                                    :disable="loading"
                                    ...
                                    >
                                        ...
                                        >
                                            <q-btn
                                                ...
                                                data-cy="aui-cfunconditional-destination-add"
                                                color="primary"
                                                icon="add"
                                                size="sm"
                                                unelevated
                        ...
                        <q-expansion-item
                            ...
                            expand-separator
                            label="TimeSet"
                            data-cy="aui-cfunconditional-timeset"
                        >
                            <q-card>
                                <q-card-section>
                                    <q-select
                                    ...
                                    >
                                        <q-input
                                            ...
                                            :disable="loading"
                                            :label="$t('Name')"
                                            data-cy="aui-cfunconditional-timeset-name"
                                        ...
                                        >
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Year')"
                                                    data-cy="aui-cfunconditional-timeset-year"
                                                    :options="yearValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                                ...
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Through')"
                                                    data-cy="aui-cfunconditional-timeset-year-through"
                                                    :options="yearValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                            ...
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Month')"
                                                    data-cy="aui-cfunconditional-timeset-month"
                                                    :options="monthValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                                ...
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Through')"
                                                    data-cy="aui-cfunconditional-timeset-month-through"
                                                    :options="monthValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                            ...
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Day')"
                                                    data-cy="aui-cfunconditional-timeset-day"
                                                    :options="dayValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                                ...
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Through')"
                                                    data-cy="aui-cfunconditional-timeset-day-through"
                                                    :options="dayValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                            ...
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Weekday')"
                                                    data-cy="aui-cfunconditional-timeset-weekday"
                                                ...
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Through')"
                                                    data-cy="aui-cfunconditional-timeset-weekday-through"
                                                    :options="weekdayValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                            ...
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Hour')"
                                                    data-cy="aui-cfunconditional-timeset-hour"
                                                    :options="hourValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                                ...
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Through')"
                                                    data-cy="aui-cfunconditional-timeset-hour-through"
                                                    :options="hourValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                            ...
                                            <q-item-section>
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Minute')"
                                                    data-cy="aui-cfunconditional-timeset-minute"
                                                    :options="minuteValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                                ...
                                                <q-select
                                                    ...
                                                    dense
                                                    :label="$t('Through')"
                                                    data-cy="aui-cfunconditional-timeset-minute-through"
                                                    :options="minuteValue"
                                                    map-options
                                                    emit-value
                                                    :disable="loading"
                                            ...
                                            >
                                                <q-btn
                                                    ...
                                                    dense
                                                    icon="delete"
                                                    data-cy="aui-cfunconditional-timeset-delete"
                                                    size="sm"
                                                    :disable="loading"
                                    ...
                                    >
                                        ...
                                        >
                                            <q-btn
                                                ...
                                                data-cy="aui-cfunconditional-timeset-add-period"
                                                color="primary"
                                                icon="add"
                                                size="sm"
                                                unelevated
                        ...
                        <q-expansion-item
                            ...
                            expand-separator
                            label="SourceSet"
                            data-cy="aui-cfunconditional-sourceset"
                        >
                            <q-card>
                                <q-card-section>
                                    <q-select
                                    ...
                                    >
                                        <q-input
                                            ...
                                            :disable="loading"
                                            :label="$t('Name')"
                                            data-cy="aui-cfunconditional-source-name"
                                    ...
                                    <q-select
                                        ...
                                        :error="false"
                                        :label="$t('Mode')"
                                        data-cy="aui-cfunconditional-sourceset-mode"
                                    ...
                                    <q-toggle
                                        ...
                                        :label="$t('is regex')"
                                        data-cy="aui-cfunconditional-sourceset-isregex"
                                        :disable="loading"
                                    />
                                    <template
                                        ...
                                        >
                                            <q-item-section>
                                                <q-input
                                                    ...
                                                    :disable="loading"
                                                    :label="$t('Source')"
                                                    data-cy="aui-cfunconditional-source"
                                                    :error="false"
                                                    @keyup.enter="submit"
                                                />
                                            </q-item-section>
                                            ...
                                            >
                                                <q-btn
                                                    ...
                                                    dense
                                                    icon="delete"
                                                    data-cy="aui-cfunconditional-source-delete"
                                                    size="sm"
                                                    :disable="loading"
                                    ...
                                    >
                                        ...
                                        >
                                            <q-btn
                                                ...
                                                data-cy="aui-cfunconditional-source-add"
                                                color="primary"
                                                icon="add"
                                                size="sm"
                                                unelevated
                                ...
                                <q-card-section>
                                    ...
                                    >
                                        <q-input
                                            ...
                                            :disable="loading"
                                            :label="$t('Name')"
                                            data-cy="aui-cfunconditional-bnumber-name"
                                    ...
                                    <q-select
                                        ...
                                        :error="false"
                                        :label="$t('Mode')"
                                        data-cy="aui-cfunconditional-bnumberset-mode"
                                        :options="modeSourceSet"
                                        map-options
                                        emit-value
                                        :disable="loading"
                                    ...
                                    <q-toggle
                                        ...
                                        :label="$t('is regex')"
                                        data-cy="aui-cfunconditional-bnumberset-isregex"
                                        :disable="loading"
                                    />
                                    <template
                                        ...
                                        >
                                            <q-item-section>
                                                <q-input
                                                    ...
                                                    :disable="loading"
                                                    :label="$t('B-Number')"
                                                    data-cy="aui-cfunconditional-bnumberset-bnumber"
                                                    :error="false"
                                                    @keyup.enter="submit"
                                                />
                                            </q-item-section>
                                            ...
                                            >
                                                <q-btn
                                                    ...
                                                    dense
                                                    icon="delete"
                                                    data-cy="aui-cfunconditional-bnumberset-bnumber-delete"
                                                    size="sm"
                                                    :disable="loading"
                                    ...
                                    >
                                        ...
                                        >
                                            <q-btn
                                                ...
                                                data-cy="aui-cfunconditional-bnumberset-add-bnumber"
                                                color="primary"
                                                icon="add"
                                                size="sm"
                                                unelevated
